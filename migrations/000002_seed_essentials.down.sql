...
DELETE FROM user_tenant_roles
 WHERE tenant_id = '11b36b85-033d-4bb3-9e31-4c92161887c0'
    OR role_id   IN ('super-admin', 'tenant-manager', 'admin', 'operario', 'cliente_admin', 'cliente_operario');

DELETE FROM tenants WHERE id = '11b36b85-033d-4bb3-9e31-4c92161887c0';

DELETE FROM roles WHERE id IN ('super-admin', 'tenant-manager', 'admin', 'operario', 'cliente_admin', 'cliente_operario');
